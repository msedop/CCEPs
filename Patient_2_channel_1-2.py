...
# Export DataFrame to Excel file
#new_df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 3\Channel 1-2\P3CH1-2_SE.xlsx', index=True)
...
peaks, _ = find_peaks(Cxy, height=0.5)  # Adjust height for your threshold
peak_freqs = f[peaks]
