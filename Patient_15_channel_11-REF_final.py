...
folder = r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 15\Channel 11-REF final'
...
for idx in range(len(f_signals)):
    ...
    mask_section2 = (t >= 40) & (t <= 105)
    mask_section3 = (t >= 20) & (t <= 50)
    mask_section4 = (t >= 4) & (t <= 7)  # New mask section
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 15\Channel 11-REF final\P15CH11-REF_final_nofilt.xlsx', index=True)
