...
# Set larger font sizes for the whole plot
plt.rcParams.update({
...
folder = r'C:\Users\msedo\Documents\CCEPs\SJD\Data Recordings\PATIENT DATA\Patient 7\Channel 1-2'
...
for idx in range(len(f_signals)):
    ...
    mask_section1 = (t >= 19) & (t <= 27)
    mask_section2 = (t >= 40) & (t <= 100)
    mask_section3 = (t >= 20) & (t <= 50)
    mask_section4 = (t >= 120) & (t <= 190)  # New mask section
...
plt.title('Signal with maximum and minimum values')
plt.xlim([0, 250])
plt.ylim([-300, 350])
plt.legend() 
...
# Compute the coordinates of the intersection of the N1 vertical line with the P1-P2 line
x1, y1 = t[min_idx_section1], min_value_section1
x2, y2 = t[min_idx_section3], min_value_section3
x3, y3 = t[max_idx_section2], max_value_section2
...
# Calculate Matsumoto N1 amplitude
n1_matsumoto_avg = abs(y4 - y3)

# N2 amplitude
n2_amp_avg = max_value_section4 - min_value_section3

# Append N1, P1, and N2 values to the data table
data['Signal'].append('Averaged')
data['N1_Latency'].append(t[max_idx_section2])
data['N1 matsumoto'].append(n1_matsumoto_avg)
data['P1_Latency'].append(t[min_idx_section1])  # New P1
data['P1_Amplitude'].append(min_value_section1)  # New P1
data['P2_Latency'].append(t[min_idx_section3])
data['P2_Amplitude'].append(min_value_section3)
data['N2_Latency'].append(t[max_idx_section4])
...
plt.scatter(t[min_idx_section1], min_value_section1, color='red', label='P1')
plt.scatter(t[max_idx_section2], max_value_section2, color='green', label='N1')
plt.scatter(t[min_idx_section3], min_value_section3, color='blue', label='P2')
plt.scatter(t[max_idx_section4], max_value_section4, color='orange', label='N2')

# Add text labels beneath the legend
plt.text(80, 240, f'P1: lat.={t[min_idx_section1]:.2f} ms, amp.={min_value_section1:.2f} uV', ha='left')
plt.text(80, 220, f'N1: lat.={t[max_idx_section2]:.2f} ms, amp.={n1_matsumoto_avg:.2f} uV', ha='left')
plt.text(80, 200, f'P2: lat.={t[min_idx_section3]:.2f} ms, amp.={min_value_section3:.2f} uV', ha='left')
plt.text(80, 180, f'N2: lat.={t[max_idx_section4]:.2f} ms, amp.={n2_amp_avg:.2f} uV', ha='left')
...
x_mid = x_end + 1
y_text = (y_h + max_value_section4) / 2
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 10\Channel 1-2\P10CH1-2_nofilt.xlsx', index=True)
