...
folder = r'C:\Users\msedo\Documents\CCEPs\SJD\Data Recordings\PATIENT DATA\Patient 5 (3 grid positioning)\Channel 2-3'
...
for idx in range(len(f_signals)):
    ...
    mask_section1 = (t >= 20) & (t <= 27)
    mask_section2 = (t >= 40) & (t <= 100)
    mask_section3 = (t >= 20) & (t <= 50)
    mask_section4 = (t >= 9) & (t <= 13)  # New mask section
...
mask_section4 = (t >= 17) & (t <= 20)  # New mask section
...
plt.text(80, -120, f'P1: lat.={t[max_idx_section4]:.2f} ms, amp.={max_value_section4:.2f} uV', ha='left')
plt.text(80, -100, f'N1: lat.={t[min_idx_section1]:.2f} ms, amp.={n1_matsumoto_avg:.2f} uV', ha='left')
plt.text(80, -80, f'P2: lat.={t[max_idx_section2]:.2f} ms, amp.={max_value_section2:.2f} uV', ha='left')
plt.text(80, -60, f'N2: lat.={t[min_idx_section3]:.2f} ms, amp.={n2_amp_avg:.2f} uV', ha='left')
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 4 (3 grid positioning)\Channel 2-3\P4CH2-3_nofilt.xlsx', index=True)
