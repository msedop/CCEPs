...
folder = r'C:\Users\msedo\Documents\CCEPs\SJD\Data Recordings\PATIENT DATA\Patient 6\Channel 1-2 (extra)'
...
plt.text(100, 140, f'P1: lat.={t[max_idx_section4]:.2f} ms, amp.={max_value_section4:.2f} uV', ha='left')
plt.text(100, 160, f'N1: lat.={t[min_idx_section1]:.2f} ms, amp.={n1_matsumoto_avg:.2f} uV', ha='left')
plt.text(100, 180, f'P2: lat.={t[max_idx_section2]:.2f} ms, amp.={max_value_section2:.2f} uV', ha='left')
plt.text(100, 200, f'N2: lat.={t[min_idx_section3]:.2f} ms, amp.={n2_amp_avg:.2f} uV', ha='left')
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 12\Channel 1-2 (extra)\P12CH1-2_nofilt.xlsx', index=True)
