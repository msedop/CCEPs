...
folder = r'C:\Users\msedo\Documents\CCEPs\SJD\Data Recordings\PATIENT DATA\Patient 4 (surgery)\Channel 4-5 final signals'
...
for i in np.array(range(0, len(file_names))):
    ...
    ax2.plot(t, filtered_y, label='Filtered Signal 4th Order Butterworth bandpass [10-1500] Hz')
...
ax2.set_title('Filtered Signal 4th Order Butterworth bandpass [10-1500] Hz')
ax2.grid('minor')
...
mask_section4 = (t >= 9) & (t <= 20)  # New mask section
...
plt.text(75, -300, f'P1: lat.={t[max_idx_section4]:.2f} ms, amp.={max_value_section4:.2f} uV', ha='left')
plt.text(75, -260, f'N1: lat.={t[min_idx_section1]:.2f} ms, amp.={n1_matsumoto_avg:.2f} uV', ha='left')
plt.text(75, -220, f'P2: lat.={t[max_idx_section2]:.2f} ms, amp.={max_value_section2:.2f} uV', ha='left')
plt.text(75, -180, f'N2: lat.={t[min_idx_section3]:.2f} ms, amp.={n2_amp_avg:.2f} uV', ha='left')
...
#df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 3 (surgery)\Channel 4-5 final signals\P3CH4-5f_nofilt.xlsx', index=True)
...
# Export DataFrame to Excel file
new_df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 4 (surgery)\Channel 4-5 final signals\P4CH4-5_end_SE.xlsx', index=True)
