...
folder = r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 13\Channel 11-REF'
...
for idx in range(len(f_signals)):
    ...
    mask_section4 = (t >= 4) & (t <= 10)  # New mask section
...
#df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 15\Channel 11-REF\P15CH11-REF_nofilt.xlsx', index=True)
