...
for i in np.array(range(0, len(file_names))):
    ...
    # Print the StartTime of each signal in the order they're stored
    print(f'Signal {i+1} StartTime:', info['StartTime'])
    # ---------------- Plotting results ---------------------------------------
...
# Create masks for the sections
mask_section1 = (t >= 10) & (t <= 40)
mask_section2 = (t >= 20) & (t <= 68)
mask_section3 = (t >= 80) & (t <= 150)
mask_section4 = (t >= 6) & (t <= 12)  # New mask section
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 9\Channel 2-3\P11CH2-3_NEW.xlsx', index=True)
