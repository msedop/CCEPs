...
folder_path_DC = r'C:\Users\msedo\Documents\CCEPs\Analysis data\Diagnosis\Cortical Dysplasia'
DC = merge_excel_files_in_folder(folder_path_DC)
DC = DC[(DC['N1 matsumoto'] >= 0) & (DC['N1 matsumoto'] <= 400) & (DC['N2_Amplitude'] <= 400) & (DC['N1_Latency'] <= 48)]

folder_path_EM = r'C:\Users\msedo\Documents\CCEPs\Analysis data\Diagnosis\Mesial Sclerosis'
EM = merge_excel_files_in_folder(folder_path_EM)
EM = EM[(EM['N1 matsumoto'] >= 0) & (EM['N1 matsumoto'] <= 400) & (EM['N2_Amplitude'] <= 400) & (EM['N1_Latency'] <= 48)]

folder_path_T = r'C:\Users\msedo\Documents\CCEPs\Analysis data\Diagnosis\Tumoral'
T = merge_excel_files_in_folder(folder_path_T)
T = T[(T['N1 matsumoto'] >= 0) & (T['N1 matsumoto'] <= 400) & (T['N2_Amplitude'] <= 400) & (T['N1_Latency'] <= 48)]

folder_path_I = r'C:\Users\msedo\Documents\CCEPs\Analysis data\Diagnosis\Vascular'
...
print("Statistics of DC dataset: ")
compute_statistics(DC)

print("Statistics of EM dataset: ")
compute_statistics(EM)

print("Statistics of T dataset: ")
compute_statistics(T)

print("Statistics of I dataset: ")
...
plot_histograms(DC, 'DC')

plot_histograms(EM, 'EM')
...
def plot_combined_violin(variable_name, svar, ag1, ag2, ag3, ag4, units='units'):
    """
    ...
    data_ag1 = {
        svar: ['Cortical Dysplasia'] * len(ag1[variable_name]),
    ...
    data_ag2 = {
        svar: ['Mesial scoliosis'] * len(ag2[variable_name]),
    ...
    data_ag3 = {
        svar: ['Tumoral'] * len(ag3[variable_name]),
    ...
    data_ag4 = {
        svar: ['Vascular'] * len(ag4[variable_name]),
        variable_name: ag4[variable_name]
    }
    df_ag4 = pd.DataFrame(data_ag4)
    
    # Combine data into a single DataFrame for plotting
    df_combined = pd.concat([df_ag1, df_ag2, df_ag3, df_ag4], ignore_index=True)
    ...
    groups = [ag1, ag2, ag3, ag4]
    diagnoses = ['Cortical Dysplasia', 'Mesial scoliosis', 'Tumoral', 'Vascular']
...
plot_combined_violin('N1_Latency','Diagnosis', DC, EM, T, I, units = 'ms')


# --------------------------- N1 amplitude Violin plots ---------------------------------

plot_combined_violin('N1 matsumoto','Diagnosis', DC, EM, T, I, units = 'µV')

# --------------------------- P2 latency Violin plots ---------------------------------

plot_combined_violin('P2_Latency','Diagnosis', DC, EM, T, I, units = 'ms')

# --------------------------- N2 latency Violin plots ---------------------------------

plot_combined_violin('N2_Latency','Diagnosis', DC, EM, T, I, units = 'ms')

# --------------------------- N2 amplitude Violin plots ---------------------------------

plot_combined_violin('N2_Amplitude','Diagnosis', DC, EM, T, I, units = 'µV')
