...
folder = r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 12\Channel 3-4'
...
for idx in range(len(f_signals)):
    ...
    mask_section2 = (t >= 50) & (t <= 100)
    mask_section3 = (t >= 20) & (t <= 70)
    mask_section4 = (t >= 15) & (t <= 15)  # New mask section
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 12\Channel 3-4\P14CH3-4_nofilt.xlsx', index=True)
