...
folder_path_ag2 = r'C:\Users\msedo\Documents\CCEPs\Analysis data\Age\-8'

# Merge Excel files from the specified folder
ag2 = merge_excel_files_in_folder(folder_path_ag2)
ag2 = ag2[(ag2['N1 matsumoto'] >= 0) & (ag2['N1 matsumoto'] <= 400) & (ag2['N2_Amplitude'] <= 400) & (ag2['N1_Latency'] <= 48)]

# Display the merged DataFrame
#print(ag2)

folder_path_ag3 = r'C:\Users\msedo\Documents\CCEPs\Analysis data\Age\+8'

ag3 = merge_excel_files_in_folder(folder_path_ag3)
ag3 = ag3[(ag3['N1 matsumoto'] >= 0) & (ag3['N1 matsumoto'] <= 400) & (ag3['N2_Amplitude'] <= 400) & (ag3['N1_Latency'] <= 48)]
...
print("Statistics of 5-8 years dataset: ")
compute_statistics(ag2)

print("Statistics of > 8 years dataset: ")
compute_statistics(ag3)
...
plot_histograms(ag2, '5-8 years')

plot_histograms(ag3, '> 8 years')
...
def plot_combined_violin(variable_name, svar, ag2, ag3, units='units'):
    """
    ...
    data_ag2 = {
        svar: ['5-8 years'] * len(ag2[variable_name]),
    ...
    data_ag3 = {
        svar: ['>8 years'] * len(ag3[variable_name]),
        variable_name: ag3[variable_name]
    }
    df_ag3 = pd.DataFrame(data_ag3)
    
    # Combine data into a single DataFrame for plotting
    df_combined = pd.concat([df_ag2, df_ag3], ignore_index=True)
    ...
    for i in range(len(groups)):
        for j in range(i + 1, len(groups)):
            ...
            if p_value < 0.05:
                p_value_str += "*"
            plt.text(x_loc, y_loc, f"{ages[i]} vs {ages[j]}: {p_value_str}", fontsize=20, va='top')
'''
...
plot_combined_violin('N1_Latency','Age Group', ag2, ag3, units='ms')


# --------------------------- N1 amplitude Violin plots ---------------------------------

plot_combined_violin('N1 matsumoto','Age Group', ag2, ag3, units='µV')

# --------------------------- P2 latency Violin plots ---------------------------------

plot_combined_violin('P2_Latency','Age Group', ag2, ag3, units='ms')

# --------------------------- N2 latency Violin plots ---------------------------------

plot_combined_violin('N2_Latency','Age Group', ag2, ag3, units='ms')

# --------------------------- N2 amplitude Violin plots ---------------------------------

plot_combined_violin('N2_Amplitude','Age Group', ag2, ag3, units='µV')
