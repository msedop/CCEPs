...
folder = r'C:\Users\msedo\Documents\CCEPs\SJD\Data Recordings\PATIENT DATA\Patient 4 (surgery)\Channel 4-5'
...
plt.rcParams.update({
    ...
    'axes.labelsize': 14,      # Axis label size (for both x and y axes)
    'xtick.labelsize': 14,     # X-tick label size
    'ytick.labelsize': 14,     # Y-tick label size
    'font.size': 12            # General font size (this affects legends, annotations, etc.)
})
...
# Export DataFrame to Excel file
#new_df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 4 (surgery)\Channel 4-5\P4CH4-5_SE.xlsx', index=True)
