...
folder = r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 12\Channel 3-4 end'
...
for idx in range(len(f_signals)):
    ...
    mask_section2 = (t >= 58) & (t <= 150)
    mask_section3 = (t >= 20) & (t <= 70)
    mask_section4 = (t >= 12.9) & (t <= 12.9)  # New mask section
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 12\Channel 3-4 end\P14CH3-4_end_nofilt.xlsx', index=True)
