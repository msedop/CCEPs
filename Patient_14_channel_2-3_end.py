...
folder = r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 14\Channel 2-3 end'
...
for idx in range(len(f_signals)):
    ...
    mask_section1 = (t >= 12) & (t <= 33)
    mask_section2 = (t >= 40) & (t <= 120)
    mask_section3 = (t >= 20) & (t <= 70)
    mask_section4 = (t >= 9.5) & (t <= 12)  # New mask section
...
mask_section2 = (t >= 20) & (t <= 60)
mask_section3 = (t >= 40) & (t <= 100)
mask_section4 = (t >= 12) & (t <= 12)  # New mask section
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 14\Channel 2-3 end\P14CH2-3_end_nofilt.xlsx', index=True)
