...
folder = r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 8\Channel 5-6'
...
for idx in range(len(f_signals)):
    ...
    mask_section4 = (t >= 5.2) & (t <= 12)  # New mask section
...
mask_section4 = (t >= 5.2) & (t <= 8)  # New mask section
...
df.to_excel(r'C:\Users\marti\OneDrive\Documents\UPC\Quart de carrera\8th Cuatrimestre\TFG\SJD\Data Recordings\PATIENT DATA\Patient 9\Channel 5-6\P9CH5-6_nofilt.xlsx', index=True)
